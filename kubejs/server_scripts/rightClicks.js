...
ItemEvents.rightClicked(event => {
	...
	if (event.item == 'kubejs:unidentified_glyph_scroll') {
		...
		player.setStatusMessage(Text.translate("kubejs.script.server.scripts.rightclicks.0007").white().append(Text.of(displayName).lightPurple().italic()));
	}
    ...
    let displayName = lootItem.split(':')[1].replace('glyph_', '').replace('_', ' ');
    player.setStatusMessage(Text.translate("kubejs.script.server.scripts.rightclicks.0008").gold().append(Text.of(displayName).lightPurple().italic().bold()));
	}
    ...
    let displayName = lootItem.split(':')[1].replace('glyph_', '').replace('_', ' ');
	player.setStatusMessage(Text.translate("kubejs.script.server.scripts.rightclicks.0009").white().append(Text.of(displayName).lightPurple().italic()));
}
});